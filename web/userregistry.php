...
<a href="login.php?">ログインページに戻る</a>
	<div class="container">
		...
		<form method="POST" name="userdata" action="userregistrycheck.php" onSubmit="return ParamCheck()">
			...
			<div id="userID"> ユーザID<span class="text-danger">※</span></div><input type="TEXT" class="form-control" name="userID" maxlength="64" /><br>
			</div>
			<div class="form-group">
			<div id="pass">パスワード<span class="text-danger">※</span></div><input type="PASSWORD" class="form-control" name="pass" maxlength="32"/><br>
			</div>
			<div class="form-group">
